classdef parfor_wait < handle
   ...
   methods
       function Obj = parfor_wait(TotalMessage, varargin)
           ...
           addParameter(InParser,'Message','',@ischar)
           ...
           Obj.Message = InParser.Results.Message;
           if Obj.Waitbar
               Obj.WaitbarHandle = waitbar(0, Obj.Message, 'Resize', true);
           end
           switch Obj.FileName
               case 'screen'
               otherwise
   ...
   methods (Access = private)
       ...
       function WaitbarUpdate(Obj)
           ...
           pctdone = Obj.NumMessage/Obj.TotalMessage*100;
           EstimatedTimeNeeded = (UsedTime_now-Obj.UsedTime_1)/Obj.ReportInterval*(Obj.TotalMessage-Obj.NumMessage);
           waitbar(Obj.NumMessage/Obj.TotalMessage, ...
               Obj.WaitbarHandle, ...
               sprintf('%s\n%.2f%% done, est. time remaining: %.2f minutes',Obj.Message,pctdone,EstimatedTimeNeeded/60));
